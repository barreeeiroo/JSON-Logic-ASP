...
def test_generate_multiple_rule_asp_definition(rule_inputs, with_comments, custom_nodes,
                                               expected_statements, expected_mapping):
...
def test_generate_single_rule_asp_definition(mock_generate_multiple_rule_asp_definition, with_comments, custom_nodes):
    ...
    mock_generate_multiple_rule_asp_definition.assert_called_once_with(
        rule_inputs=[ri], with_comments=with_comments, custom_nodes=custom_nodes,
    )
