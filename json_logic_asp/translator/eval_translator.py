...
from json_logic_asp.translator.adapters.asp.asp_statements import ShowStatement
from json_logic_asp.translator.data_generator import generate_single_data_asp_definition
from json_logic_asp.translator.models.translator import DataInput, DataOutput, RuleInput
...
def translate_multi_rule_eval(rule_inputs: List[RuleInput], data_input: DataInput, with_comments: bool = False) -> DataOutput:
    stmts: List[str] = []
